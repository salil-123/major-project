...
def return_pytorch04_xception(pretrained=True):
    ...
    if pretrained:
        ...
        state_dict = torch.load(            
            'A:/major project/FaceForensics-Detection_Website-master/videos/xception-b5690688.pth')
...
class TransferModel(nn.Module):
        ...
        if modelchoice == 'XceptionNet':
            ...
            if not dropout:
                ...
                self.model.last_linear = nn.Sequential(
                    nn.Dropout(p=dropout), nn.Linear(num_ftrs,
                                                     num_out_classes))
    ...
    def set_trainable_up_to(self, boolean, layername="Conv2d_4a_3x3"):
        ...
        if boolean:
            ...
            if self.modelchoice == 'XceptionNet':
                # Make fc trainable
...
def model_selection(modelname, num_out_classes, dropout=None):
    ...
    if modelname == 'XceptionNet':
        return TransferModel(modelchoice='XceptionNet',
